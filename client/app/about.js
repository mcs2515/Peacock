	...
	return(
		<form>
			<h1>Website Updates:</h1>
				...
				<div id="logs">
					<ul>
						<li><time>Apr 13, 2018</time> Created about page.</li>
						...
						<li><time>Apr 5, 2018</time> <a href="https://jariz.github.io/vibrant.js/">Vibrant.js</a> now extracts colors from all images saved.</li>
						<li><time>Apr 4, 2018</time> Implemented <a href="https://jariz.github.io/vibrant.js/">Vibrant.js</a> to work for only one image. </li>
				...
				<section id="logFooter">
					<p>For detailed list of changes: </p><a href="https://github.com/mcs2515/Peacock_Final/commits/master"> Github </a>
				</section>
		</form>
	);
}
